    ...
    function dFields(m) {
      const age = calcAge(m.birth);
      const birthTxt = m.birth ? (m.birth + (m.birthCal === 'lunar' ? ' (음)' : (m.birthCal === 'solar' ? ' (양)' : '')) + (age != null ? ` · 만 ${age}세` : '')) : '';
    ...
    function dColsBody(m) {
      const age = calcAge(m.birth);
      const birthTxt = m.birth ? (esc(m.birth) + (m.birthCal === 'lunar' ? ' (음)' : (m.birthCal === 'solar' ? ' (양)' : '')) + (age != null ? ` · 만 ${age}세` : '')) : '';
